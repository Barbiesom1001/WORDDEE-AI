...
export default function Dashboard() {
  ...
  return (
<div className="min-h-screen bg-[#fdf2f8]" suppressHydrationWarning>      <nav className="bg-white py-4 px-8 flex justify-between items-center shadow-sm sticky top-0 z-10">
